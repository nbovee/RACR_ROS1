git clone -q http://github.com/pal-robotics/ddynamic_reconfigure/ src/ddynamic_reconfigure/
git clone -q http://github.com/tu-darmstadt-ros-pkg/hector_slam src/hector_slam/
# git clone -q http://github.com/praveen-palanisamy/multiple-object-tracking-lidar src/multiple-object-tracking-lidar/
git clone -q http://github.com/ros-planning/navigation src/navigation/
